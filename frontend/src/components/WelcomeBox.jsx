...
const WelcomeBox = () => {
    return (
        <motion.div
            ...
            className="bg-white shadow-xl rounded-2xl px-8 py-6 border border-gray-200 text-gray-800 max-w-md w-full text-center break-words overflow-hidden"
        >
            <h2 className="text-2xl font-semibold mb-4 break-words">
                Willkommen zur Anatomy 3D Lern-App
            </h2>
